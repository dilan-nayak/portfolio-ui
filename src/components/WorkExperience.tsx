      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <motion.div
            ...
            className="grid grid-cols-1 lg:grid-cols-[220px_1px_1fr] gap-8 lg:gap-8 items-start"
          >
                ...
                return (
                  <div key={company.companyFullName} className="w-full">
                    <button
                      ...
                      className="w-full text-left whitespace-nowrap lg:whitespace-normal px-1 py-3 transition-all duration-300 appearance-none bg-transparent border-0 outline-none focus:outline-none focus-visible:outline-none focus-visible:ring-0 focus-visible:shadow-none"
              ...
              <div className="space-y-8">
                {active.positions.map((position, positionIndex) => {
                  ...
                  return (
                    ...
                    >
                      <div className="absolute left-0 top-2 h-3.5 w-3.5 rounded-full bg-[#8f332a] dark:bg-red-400" />
                      {!isLastPosition ? (
                        <div className="absolute left-[6px] top-6 bottom-0 w-px bg-zinc-300 dark:bg-zinc-700" />
                      ) : null}

                      <h4 className="text-xl font-bold theme-text-primary text-zinc-900 dark:text-zinc-100">
                        {position.title}
                      </h4>
